...
expansion from machine templates,
...
| `crates/control-client` | Synchronous fixed-buffer host boundary for sending commands, validating responses, and correlating clock exchanges |
